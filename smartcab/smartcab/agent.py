...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        to_epsilon = self.epsilon * self.decay
        if to_epsilon >= 0:
            self.epsilon = to_epsilon
    ...
    def learn(self, state, action, reward):
        ...
        q1 = q + self.alpha * (reward - q)
        
        self.Q[state][action] = q1
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning=True, epsilon=0.99, alpha=0.5)
